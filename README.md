...
```bash
curl -sSL https://raw.githubusercontent.com/ankittk/airlock/main/install.sh | AIRLOCK_VERSION=v0.1.0-beta.3 bash
# or: go install github.com/ankittk/airlock/cmd/airlock@v0.1.0-beta.3
```
